...
class NpcAlchemist(Character, Handle_Animations):
    ...
    def __init__(self, z=0, x=0, y=0):
        ...
        # TODO: These all need the correct icon images
        # 1-2-3     7-8-9
        # 4-5-6    10-11-12     
        ...
        self.IconOne = pygame.image.load('./assets/zombie.png').convert_alpha()
        self.IconOne = pygame.transform.scale(self.IconOne,(64, 64))

        self.IconTwo = pygame.image.load('./assets/zombie.png').convert_alpha()
        self.IconTwo = pygame.transform.scale(self.IconTwo,(64, 64))

        self.IconThree = pygame.image.load('./assets/zombie.png').convert_alpha()
        ...
        loc_in_sprite_sheet = self.pull_sprite(2, 3, file="alchemist.png")
